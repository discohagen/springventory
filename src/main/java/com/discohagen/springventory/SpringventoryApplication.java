...
public class SpringventoryApplication {
    ...
    public CommandLineRunner loadData(ItemRepository itemRepository, LocationRepository locationRepository) {
        return (args) -> {
            Location warehouse = new Location(null, "Warehouse", "Main warehouse", null, null, null);
            Location store = new Location(null, "Store", "A retail store", null, null, null);
            locationRepository.save(warehouse);
            locationRepository.save(store);

            Location sectionA = new Location(null, "Section A", "Section A of the warehouse", warehouse, null, null);
            locationRepository.save(sectionA);

            Item smartphone = new Item(null, "Smartphone", "A smart phone", 10, warehouse);
            Item mouse = new Item(null, "Mouse", "A computer mouse", 55, warehouse);
            Item keyboard = new Item(null, "Keyboard", "A computer keyboard", 13, warehouse);
            Item desktop = new Item(null, "Desktop", "A desktop pc", 20, store);
            Item cable = new Item(null, "Cable", "A power cable", 44, store);
            Item laptop = new Item(null, "Laptop", "A Laptop", 30, sectionA);
            Item powerBrick = new Item(null, "Power Brick", "A power brick", 12, sectionA);
